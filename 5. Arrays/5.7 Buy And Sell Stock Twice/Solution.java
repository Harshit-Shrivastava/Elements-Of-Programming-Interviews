public class Solution {
    public static double buyAndSellStockTwice(List<Double> prices) {
        ...
        // Forward phase, for each day, we record maximum profit we if we sell on that day
        ...
        // Backwards phase, for each day, find maximum profit if we make the second buy on that day
